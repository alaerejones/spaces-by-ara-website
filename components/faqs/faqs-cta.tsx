      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <p className="text-md text-white/80 leading-relaxed mb-10">
            Contact us directly and our team will be happy to help you with any questions about our homes, investments, or services.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="mailto:hello@spacesbyara.com">Contact Us</Link>
            </Button>
            <Button
              asChild
              size="lg"
